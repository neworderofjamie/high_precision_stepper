...
namespace HighPrecisionStepperJuggler
{
    public class UVCCameraPlugin : MonoBehaviour
    {
        ...
        [SerializeField] private int _cameraDevice;
        [SerializeField] private bool _bayer;

        [DllImport("UVCCameraPlugin", CallingConvention = CallingConvention.Cdecl)]
        ...
        void Start()
        {
            ...
            SetDllDirectory("C:\\Users\\newor\\Documents\\sussex\\HighPrecisionStepperJuggler-master\\Unity\\HighPrecisionStepperJuggler\\Assets\\Plugins\\UVC Camera Plugin");
            _camera = getCamera((int)_cameraDevice);
